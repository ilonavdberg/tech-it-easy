...
public class WallBracketController {
    ...
    @PostMapping
    public ResponseEntity<WallBracketResponseDto> createWallBracket(@RequestBody WallBracketRequestDto request) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<WallBracketResponseDto> updateWallBracket(@PathVariable Long id, @RequestBody WallBracketRequestDto request) {
        WallBracket wallBracket = WallBracketMapper.toWallBracket(request);
